...
`,r=e("rndvid");class i{canvas;static displayName;context;constructor(e,t){this.canvas=e;let o=e.getContext(t);if(!o)throw i.rendererNotSupported(t);this.context=o}static rendererNotSupported(e){let t=`renderer not supported: ${e}`;return alert(t),Error(t)}}class a extends i{lTime;initialTime;constructor(e,t,o,r){function i(e,t){let o=c.createShader(e);if(!o)throw Error("failed to create shader");if(c.shaderSource(o,t),c.compileShader(o),!c.getShaderParameter(o,c.COMPILE_STATUS))throw console.error(c.getShaderInfoLog(o)),console.log(t),c.deleteShader(o),Error("failed to compile shader");return o}super(e,t);let c=this.context,n=i(c.VERTEX_SHADER,o),s=i(c.FRAGMENT_SHADER,r),l=c.createProgram();if(!l)throw Error("failed to create program");if(c.attachShader(l,n),c.attachShader(l,s),c.linkProgram(l),!c.getProgramParameter(l,c.LINK_STATUS))throw console.error(c.getProgramInfoLog(l)),c.deleteProgram(l),Error("failed to link program");c.useProgram(l),this.lTime=c.getUniformLocation(l,"iTime"),this.initialTime=a.currentTime();let d=c.createBuffer();c.bindBuffer(c.ARRAY_BUFFER,d),c.bufferData(c.ARRAY_BUFFER,new Float32Array([-1,-1,1,-1,-1,1,1,1]),c.STATIC_DRAW);let h=c.getAttribLocation(l,"pos");c.vertexAttribPointer(h,2,c.FLOAT,!1,0,0),c.enableVertexAttribArray(h)}render(){let e=this.context;e.uniform1f(this.lTime,(a.currentTime()-this.initialTime)/1e3),e.viewport(0,0,this.canvas.width,this.canvas.height),e.drawArrays(e.TRIANGLE_STRIP,0,4)}static currentTime(){return(performance||Date).now()}}class c extends a{constructor(e,t){let o=`#version 300 es
    #ifdef GL_ES
    ...
    `+t)}}let n=[class extends i{static displayName="2d WebCrypto";constructor(e){super(e,"2d")}render(){let e=new Uint8Array(Math.min(65536,this.canvas.width*this.canvas.height*3)),t=65536,o=this.context.createImageData(this.canvas.width,this.canvas.height);for(let r=(this.canvas.width*this.canvas.height<<2)-1;r;--r){let i=255;3&~r&&(65536===t&&(t=0,crypto.getRandomValues(e)),i=e[t++]),o.data[r]=i}this.context.putImageData(o,0,0)}},class extends i{static displayName="2d Math.random";constructor(e){super(e,"2d")}render(){let e=this.context.createImageData(this.canvas.width,this.canvas.height);for(let t=(this.canvas.width*this.canvas.height<<2)-1;t;--t)e.data[t]=3&~t?256*Math.random()|0:255;this.context.putImageData(e,0,0)}},class extends a{static displayName="webgl";constructor(e){let o=`
    #ifdef GL_ES
      precision highp float;
      precision highp int;
    #endif
